...
% <<二进制数11111111111:长度11位, B:2位, C:2位, _D:1位, E:4位, F:2位, G:1位, Bits:9位>>
decode_header(<<2#11111111111:11, B:2, C:2, _D: 1, E:4, F:2, G:1, Bits:9>>) ->
    ...
    if
        FrameLength < 21 ->
            exit(FrameLength);
        true ->
            % Here, Return 0 as FrameLength, convenience for test
            {ok, 0, {Layer, BitRate, SampleRate, Vsn, Bits}}
    end;
...
framelength(Layer, BitRate, SampleRate, Padding) ->
    Layer * BitRate * SampleRate * Padding.
